...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2019 at 12:28 PM
...
--
ALTER TABLE `nilai`
  ADD CONSTRAINT `nilai_ibfk_1` FOREIGN KEY (`id_alternatif`) REFERENCES `nilai` (`id`),
  ADD CONSTRAINT `nilai_ibfk_2` FOREIGN KEY (`id_kriteria`) REFERENCES `nilai` (`id`);
COMMIT;
